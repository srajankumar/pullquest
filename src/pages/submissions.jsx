      ...
      <div className="w-full flex flex-wrap text-justify justify-center md:p-10 p-5 mb-10">
        {Object.values(data).map((item) => (
          <a
            ...
            key={item.username}
          >
            <div className="transform sm:hover:scale-105 hover:normal-case w-[27rem] transition-all duration-300 flex items-center backdrop-blur-lg shadow-2xl rounded-xl font-bold p-5 m-3">
              <div className="flex">
                <img
                  alt="dp"
                  className="px-2 w-24"
