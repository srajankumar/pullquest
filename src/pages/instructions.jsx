...
function App() {
  ...
  const renderTextArea = (index) => {
    return (
      <textarea
        ...
        value={texts[index]}
        readOnly
        className="flex pl-8 h-full sm:pt-6 sm:text-xl w-full bg-white resize-none rounded-xl text-xs no-focus-outline"
  ...
  return (
    <>
      <Background />
      <div className="w-full text-justify justify-center md:p-10 p-5 mb-10 items-center">
